...
@Data
public class CourseStdntInstListDTO {
    ...
    private LectInfo courseOne;

    // 페이지네이션 수식 계산을 생성자에서 수행
    public CourseStdntInstListDTO(int cpg, int totalItems, int pageSize, List<?> courselist, LectInfo courseOne) {
        this.cpg = cpg;
